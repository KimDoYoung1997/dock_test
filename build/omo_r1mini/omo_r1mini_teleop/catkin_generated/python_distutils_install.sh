...
echo_and_run cd "/root/laser_extract/src/omo_r1mini/omo_r1mini_teleop"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/root/laser_extract/src/omo_r1mini/omo_r1mini_teleop/setup.py" \
     \
    build --build-base "/root/laser_extract/build/omo_r1mini/omo_r1mini_teleop" \
    install \
    --root="${DESTDIR-/}" \
